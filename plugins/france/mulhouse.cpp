...
QString
StationsPluginMulhouse::id() const
{
  return QLatin1String("mulhouse");
}

QString
StationsPluginMulhouse::name() const
{
  return QString::fromUtf8("Mulhouse");
}

QString
StationsPluginMulhouse::bikeName() const
{
  return QString::fromUtf8("VéloCité");
}

QIcon
StationsPluginMulhouse::bikeIcon() const
{
