...
QString
StationsPluginCreteil::id() const
{
  return QLatin1String("creteil");
}
...
QString
StationsPluginCreteil::bikeName() const
{
  return QString::fromUtf8("Cristolib");
}

QIcon
StationsPluginCreteil::bikeIcon() const
{
